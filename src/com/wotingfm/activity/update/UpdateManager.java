package com.wotingfm.activity.update;
...
public class UpdateManager  extends BaseActivity {
	...
	//提示语
	private String updateMsg = "有最新版本，亲快下载吧~";
	
	//返回的安装包url
	private String apkUrl = "http://www.ym18.cn/appupgrade/yumikefu.apk";
...
//    private static final String savePath = Environment.getExternalStorageDirectory().getAbsolutePath(); ;
    ...
    private static final String saveFileName = savePath + "yumikefu.apk";
...
//		View v = inflater.inflate(R.layout.ym_upgrade_progress, null);
